import { Home, Users, Settings, Info, ChevronLeft, ChevronRight, Fingerprint, Sparkles, Server, Shield, Bot, UserPlus, CreditCard } from 'lucide-react'
...
export type PageType = 'home' | 'accounts' | 'automation' | 'machineId' | 'kiroSettings' | 'proxy' | 'kproxy' | 'register' | 'subscription' | 'settings' | 'about'
...
const menuItemsConfig: { id: PageType; labelKey: string; icon: React.ElementType }[] = [
  ...
  { id: 'automation', labelKey: 'nav.automation', icon: Bot },
