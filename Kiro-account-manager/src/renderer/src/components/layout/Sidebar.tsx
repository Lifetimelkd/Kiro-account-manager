import { Home, Users, Settings, Info, ChevronLeft, ChevronRight, Fingerprint, Sparkles, Server, Shield, Bot } from 'lucide-react'
...
export type PageType = 'home' | 'accounts' | 'automation' | 'machineId' | 'kiroSettings' | 'proxy' | 'kproxy' | 'settings' | 'about'
